...
const isFinishingTurn = ref(false);
...
const onFinishPlacement = async () => {
  if (isFinishingTurn.value) {
    console.warn("[FINISH TURN] Mehrfachklick ignoriert");
    return;
  }

  isFinishingTurn.value = true;
